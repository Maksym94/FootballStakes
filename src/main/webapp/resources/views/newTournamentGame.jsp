...
<title>New tournament game</title>
</head>
<body>
<h3>Creating new tournament game</h3><br>
<form:form action="${contextPath}/new-tournament-game" method="POST"  
...
data-template="DD / MM / YYYY     HH : mm" name="startDate" value="21-12-2012 20:30" type="text">
   </td>

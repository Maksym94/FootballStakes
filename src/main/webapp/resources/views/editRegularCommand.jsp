...
<title>Edit regular command</title>
</head>
<body>
<h3>Edit regular command</h3><br>
<form:form action="${contextPath}/edit-regular-command" method="POST" 
modelAttribute="regularCommand" enctype="multipart/form-data">
<img alt="regular command" src="${contextPath}/${regularCommand.photoPath}" height="128" width="128"><br>
<input type="file" name="regularCommandPicture" 
accept="image/jpeg,image/png,image/gif"><br>
<table>
<tr><td><form:input path="idRegularCommand" readonly="true" disabled="true"   /><form:hidden 
path="idRegularCommand"/> </td></tr>
<tr>
